...
const mapCenter = [-76.98, 85.02]; //// ----->**CHANGE**: replace with the center coordinates from your Content map [my map: IRONGATE]
const mapZoom = 2; //// ----->**CHANGE**: initial zoom level must be >min zoom and <max zoom (defined in scripts.js)
