...
const mapCenter = [-81.63, 82.5]; //// ----->**CHANGE**: replace with the center coordinates from your Content map [my map: AZURE SEA]
const mapZoom = 5; //// ----->**CHANGE**: initial zoom level must be >min zoom and <max zoom (defined in scripts.js)
